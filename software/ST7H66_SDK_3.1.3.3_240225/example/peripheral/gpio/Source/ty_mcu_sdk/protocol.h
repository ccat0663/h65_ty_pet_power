...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#error "add tuya productk key"
#define PRODUCT_KEY "xxxxxxxx"    //开发平台创建产品后生成的16位字符产品唯一标识

#define MCU_VER "0.0.1"         //用户的软件版本,用于MCU固件升级,MCU升级版本需修改
...
#define WIFI_DATA_PROCESS_LMT           2048            //串口数据处理缓存大小,如需MCU固件升级,若单包大小选择1024,则缓存必须大于1030,若开启天气服务,则需要更大
...
//实时功率(只上报)
//备注:
#define DPID_FIRST_REAL_POWER 101
//实时功率(只上报)
//备注:
#define DPID_SECOND_REAL_POWER 102
//实时功率(只上报)
//备注:
#define DPID_THIRD_REAL_POWER 103
//当前温度(只上报)
//备注:
#define DPID_TEMP_CURRENT 104
//当前湿度(只上报)
//备注:
#define DPID_HUMIDITY_VALUE 105
//报警阈值(可下发可上报)
//备注:
#define DPID_TEMP_WARN_VALUE_SET 106
//今日用电(只上报)
//备注:
#define DPID_FIRST_DAY_ELE_ENERGY 107
//今日用电(只上报)
//备注:
#define DPID_SENCOND_DAY_ELE_ENERGY 108
//今日用电(只上报)
//备注:
#define DPID_THIRD_DAY_ELE_ENERGY 109
//报警阈值(可下发可上报)
//备注:
#define DPID_FIRST_WARN_VALUE_SET 110
//报警阈值(可下发可上报)
//备注:
#define DPID_SECOND_WARN_VALUE_SET 111
//报警阈值(可下发可上报)
//备注:
#define DPID_THIRD_WARN_VALUE_SET 112
//报警开关(可下发可上报)
//备注:
#define DPID_FIRST_WARN_SWITCH 113
//报警开关(可下发可上报)
//备注:
#define DPID_SECOND_WARN_SWITCH 114
//报警开关(可下发可上报)
//备注:
#define DPID_THIRD_WARN_SWITCH 115
//数据清零(只下发)
//备注:
#define DPID_FIRST_DATA_CLEAR 116
//数据清零(只下发)
//备注:
#define DPID_SECOND_DATA_CLEAR 117
//数据清零(只下发)
//备注:
#define DPID_THIRD_DATA_CLEAR 118
//总用电(只上报)
//备注:
#define DPID_FIRST_TOTAL_ELE_ENERGY 119
//总用电(只上报)
//备注:
#define DPID_SECOND_TOTAL_ELE_ENERGY 120
//总用电(只上报)
//备注:
#define DPID_THIRD_TOTAL_ELE_ENERGY 121
//报警开关(可下发可上报)
//备注:
#define DPID_TEMP_WARN_SWITCH 122
//第一路功率报警(只上报)
//备注:
#define DPID_FIRST_POWER_WARN 123
//第二路功率报警(只上报)
//备注:
#define DPID_SEC_POWER_WARN 124
//第三路功率报警(只上报)
//备注:
#define DPID_THIRD_POWER_WARN 125
//温湿度报警(只上报)
//备注:
#define DPID_TEMP_HUMI_WARN 126
//温湿度传感器错误(只上报)
//备注:
#define DPID_TEMP_SENSOR_ERROR 127
//第一路传感器错误(只上报)
//备注:
#define DPID_FIRST_SENSOR_ERROR 128
//第二路传感器错误(只上报)
//备注:
#define DPID_SEC_SENSOR_ERROR 129
//第三路传感器错误(只上报)
//备注:
#define DPID_THIRD_SENSOR_ERROR 130
//报警阈值(可下发可上报)
//备注:
#define DPID_HUMI_WARN_VALUE_SET 131
//系统复位(只上报)
//备注:
#define DPID_SYS_RESET 132
//今日用电(只上报)
//备注:
#define DPID_DAY_THREE_ELE_ENERGY 133
//总用电(只上报)
//备注:
#define DPID_TOTAL_THREE_ELE_ENERGY 134
//总功率(只上报)
//备注:
#define DPID_TOTAL_REAL_POWER 135
